...
const navItems = [
  ...
  { id: "library", label: "B-Roll Library", icon: "🎬" },
  { id: "inspiration", label: "Inspiration Feed", icon: "🔥" },
  { id: "production", label: "Production Queue", icon: "🎯" },
...
export default function Home() {
  ...
  return (
    <div className="flex h-screen bg-[#0a0a0f] text-white overflow-hidden">
      {/* Sidebar */}
      <div className="w-64 bg-[#111118] border-r border-white/10 flex flex-col">
        {/* Logo */}
        <div className="p-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center text-sm font-bold">
              💥
            </div>
            <div>
